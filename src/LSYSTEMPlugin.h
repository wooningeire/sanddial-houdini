...
private:
	...
	fpreal ANGLE_SCALE(fpreal t) {
        return evalFloat("angle_scale", 0, t); 
    }
	fpreal ANGLE_NOISE(fpreal t) {
        return evalFloat("angle_noise", 0, t); 
    }
	int ANGLE_SEED(fpreal t) {
        return evalInt("angle_seed", 0, t); 
    }
	fpreal STEP(fpreal t) {
        return evalFloat("step", 0, t); 
    }
	fpreal STEP_SCALE(fpreal t) {
        return evalFloat("step_scale", 0, t); 
    }
	fpreal STEP_NOISE(fpreal t) {
        return evalFloat("step_noise", 0, t); 
    }
	int STEP_SEED(fpreal t) {
        return evalInt("step_seed", 0, t); 
    }
	fpreal GRAVITY(fpreal t) {
        return evalFloat("gravity", 0, t); 
    }
	void GRAMMAR(UT_String &s, fpreal t) {
        evalString(s, "grammar", 0, t); 
    }
	int N_ITERATIONS(fpreal t) {
        return evalInt("n_iterations", 0, t); 
    }
